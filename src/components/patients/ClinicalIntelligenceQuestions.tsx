import { CI_QUESTIONS } from '../../data/clinicalIntelligence'
...
export default function ClinicalIntelligenceQuestions({ answers, onAnswer, activeAIInsightId, onToggleAIInsight }: Props) {
  return (
