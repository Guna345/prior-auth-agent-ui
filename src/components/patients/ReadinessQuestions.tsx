import { READINESS_QUESTIONS } from '../../data/clinicalIntelligence'
...
export default function ReadinessQuestions({ answers, onAnswer, activeAIInsightId, onToggleAIInsight }: Props) {
  return (
