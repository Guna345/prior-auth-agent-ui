import { RISK_QUESTIONS } from '../../data/clinicalIntelligence'
...
export default function RiskQuestions({ answers, onAnswer, activeAIInsightId, onToggleAIInsight }: Props) {
  return (
        ...
        {RISK_QUESTIONS.map(q => {
          ...
          return (
            <div key={q.id} style={{ border: '1px solid #ECECEC', borderRadius: '12px', padding: '20px 24px' }}>
              ...
              <p style={{ margin: '0 0 8px', fontSize: '13px', color: '#757C8D', fontFamily: FONT, lineHeight: '1.6' }}>{q.policy}</p>
              <p style={{ margin: '0 0 14px', fontSize: '13px', color: '#757C8D', fontFamily: FONT, lineHeight: '1.6' }}>{q.question}</p>
