...
export const rules: Rule[] = [
  { ruleId: 'R001', cpt: '23513',  payer: 'BCBS PPO',         description: 'Total knee replacement requires PA for all non-emergency cases',   source: 'DB',    status: 'Active',   sourceUrl:      'healthcaresource.in/rules/bcbs-knee'       },
  { ruleId: 'R001', cpt: '23513',  payer: 'BCBS PPO',         description: 'Total knee replacement requires PA for all non-emergency cases',   source: 'Excel', status: 'Active',   sourceFileName: 'BCBS_PPO_knee_rules.csv'                   },
  { ruleId: 'R002', cpt: '27447',  payer: 'Aetna HMO',        description: 'ACL reconstruction mandates referral and pre-authorization',       source: 'DB',    status: 'Active',   sourceUrl:      'healthcaresource.in/rules/aetna-acl'       },
  { ruleId: 'R003', cpt: '298277', payer: 'Cigna POS',        description: 'Shoulder arthroscopy requires PA for outpatient procedures',       source: 'Excel', status: 'Inactive', sourceFileName: 'Cigna_POS_shoulder_rules.csv'              },
  { ruleId: 'R004', cpt: '22612',  payer: 'UnitedHealthcare', description: 'Spinal fusion surgeries require prior approval in all cases',      source: 'DB',    status: 'Active',   sourceUrl:      'healthcaresource.in/rules/uhc-spinal'      },
  { ruleId: 'R005', cpt: '274866', payer: 'Humana PPO',       description: 'Meniscus repair covered with PA only when performed outpatient',   source: 'Excel', status: 'Active',   sourceFileName: 'Humana_PPO_meniscus_rules.csv'             },
  { ruleId: 'R006', cpt: '298888', payer: 'Blue Shield HMO',  description: 'Rotator cuff repairs require documentation and PA',               source: 'DB',    status: 'Inactive', sourceUrl:      'healthcaresource.in/rules/blueshield-rotator' },
  { ruleId: 'R007', cpt: '274055', payer: 'Aetna PPO',        description: 'Knee arthroscopy needs prior authorization if inpatient',         source: 'Excel', status: 'Active',   sourceFileName: 'Aetna_PPO_knee_arthroscopy_rules.csv'      },
  { ruleId: 'R008', cpt: '298277', payer: 'Cigna POS',        description: 'Labral repair surgeries require pre-approval for coverage',       source: 'DB',    status: 'Active',   sourceUrl:      'healthcaresource.in/rules/cigna-labral'    },
  { ruleId: 'R009', cpt: '234722', payer: 'UnitedHealthcare', description: 'Joint replacement surgeries need PA for elective cases',          source: 'Excel', status: 'Inactive', sourceFileName: 'UHC_joint_replacement_rules.csv'           },
  { ruleId: 'R010', cpt: '298066', payer: 'Humana PPO',       description: 'Arthroscopic debridement requires prior authorization',           source: 'DB',    status: 'Active',   sourceUrl:      'healthcaresource.in/rules/humana-debridement' },
  { ruleId: 'R011', cpt: '27447',  payer: 'Blue Shield HMO',  description: 'Meniscectomy procedures require PA only for outpatient settings', source: 'Excel', status: 'Active',   sourceFileName: 'BlueShield_meniscectomy_rules.csv'         },
]
