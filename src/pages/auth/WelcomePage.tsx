    ...
    >
      <AuthCard>
        ...
        <div className="flex flex-col gap-3">
          ...
          <SocialButton icon={<MicrosoftIcon />} label="Sign in with Microsoft" />
          <SocialButton
            icon={<EmailIcon />}
        ...
        <p className="text-center text-xs text-gray-400 mt-6 leading-relaxed">
          ...
          <a href="#" className="underline text-gray-500 hover:text-gray-700">Terms of Service</a>
          {' '}and{' '}
          <a href="#" className="underline text-gray-500 hover:text-gray-700">Privacy Policy</a>
        </p>
      </AuthCard>
    </div>
  )
